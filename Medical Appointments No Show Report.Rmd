...
* Scholarship = Financial Aid for family depending on if the child is enrolled in an academic program.
...
* No-show = Patient does or does not show up to scheduled appointment
...
* Our data looks good! Let's dive into our first section of analysis, Age's effect on no show rates.
...
* However, looking at the proportions of who does and does not show up, both female and males are even at 20%.
...
* Based on the above plots, there are more patients who do not have scholarships, preconceived health conditions or SMS Messages.
  * Therefore, our sample size to see if these binary variables are effective is relatively small.
